...
toppingTypeDict = {Sauce.Verde:[350,330,SLOW_TIME],Sauce.Sour:[435,330,SLOW_TIME],Sauce.Hot:[520,330,SLOW_TIME],Sauce.Nacho:[1075,330,SLOW_TIME],Sauce.Mild:[1170,330,SLOW_TIME],
                   Sauce.Loco:[1260,330,SLOW_TIME],Topping.Jalapenos:[475,780,SLOW_TIME],Topping.Tomatoes:[660,780,SLOW_TIME],Topping.WRice:[830,780,FAST_TIME],
                   Topping.Lettuce:[1020,780,SLOW_TIME],Topping.Peppers:[1200,780,FAST_TIME],Topping.BBeans:[380,860,SLOW_TIME],Topping.Gaucamole:[560,860,FAST_TIME],
                   Topping.Cheese:[740,860,FAST_TIME],Topping.PBeans:[920,860,SLOW_TIME],Topping.Onions:[1105,860,SLOW_TIME],Topping.BRice:[1285,860,FAST_TIME]}
...
def addTopping(item,tutorial = None):
   ...
   if item:
      ...
      if not tutorial:
         ...
         try:
            tut2 == tutorial
            pag.moveTo(END_POUR[0],END_POUR[1],duration = (toppingTypeDict[item][2]-0.25) if toppingTypeDict[item][2] == FAST_TIME else (toppingTypeDict[item][2]))
         except:
            pag.moveTo(END_POUR[0],END_POUR[1],duration = (toppingTypeDict[item][2]+2) if toppingTypeDict[item][2] == FAST_TIME else (toppingTypeDict[item][2]))
            tut2 = True
      grl.wait(0.25)
